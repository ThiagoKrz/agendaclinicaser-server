...
INSERT INTO usuario (username, password, role, primeiro_acesso) VALUES  ('admin', '$2a$10$dv8Hg/2GJ7hiBLfA5iEE2uThd66wlZbO1YQM6eaj0GAKQDxMwGwqq', 'ADMIN', false);

INSERT INTO persona (id, dtype,  nome, sobrenome, data_nascimento, sexo, email, ddd, numero_telefone,  inativo, usuario_id)
    VALUES  ('62c43c69-49dd-4c69-9f8b-3f879a6aa91a',  'Colaborador', 'admin', 'admin', '2021-01-01', 'MASCULINO', 'admin@gmail.com', '69', '99999999', false, 1);